 ...
 * @author amy
 */
public class FastMoveToObjectAction extends MoveAction {
	 ...
	 * @param goalObject
	 */
	public FastMoveToObjectAction(Toroidal2DPhysics space, Position currentLocation, AbstractObject goalObject) {
		super(space, currentLocation, goalObject.getPosition(),space.findShortestDistanceVector(currentLocation,goalObject.getPosition()).unit().multiply(20.0));
