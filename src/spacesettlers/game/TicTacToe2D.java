...
/**
 * 2D tic tac toe or naughts and crosses
 * 
 * @author amy
 *
 */
public class TicTacToe2D extends AbstractGame {
	TicTacToe2DBoard myBoard;
	 ...
	 */
	public TicTacToe2D(final AbstractGameAgent lhs_player, final AbstractGameAgent rhs_player) {
		myBoard = new TicTacToe2DBoard();
		random = new Random();
		isPlayer1Turn = true;
	 ...
	 * @param board
	 */
	public TicTacToe2D(int [][]board, boolean player, final AbstractGameAgent player1, final AbstractGameAgent player2) {
		this.myBoard = new TicTacToe2DBoard();
	...
	public void playAction(AbstractGameAction action) {
		TicTacToe2DAction TTTAction = (TicTacToe2DAction) action;
